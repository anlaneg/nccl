...
struct ncclTransportComm {
  ...
  ncclResult_t (*setup)(struct ncclComm* comm, struct ncclTopoGraph* graph, struct ncclPeerInfo*/*本端信息*/, struct ncclPeerInfo*/*对端信息*/,
...
struct ncclTransport {
  ...
  ncclResult_t (*canConnect)(int*/*出参，可连接时置为非零*/, struct ncclComm* comm, struct ncclTopoGraph* graph, struct ncclPeerInfo*/*源信息*/,
                             struct ncclPeerInfo*/*对端信息*/);
