...
ncclResult_t ncclTopoGetNetDev(struct ncclComm* comm, int rank/*自身rank*/, struct ncclTopoGraph* graph, int channelId,
                               int peerRank/*对端rank*/, int64_t* id, int* dev, int* proxyRank) {
  int64_t netId = -1;
  int netDev = -1;
  if (graph) {
